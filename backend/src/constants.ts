...
export const PROMPT_DETECT_REFERENCES = `Wyszukaj wszystkie pliki referencyjne i zwróć je w postaci json:  Odpowiedź musi być wyłącznie poprawnym JSON-em, bez dodatkowego tekstu. Możesz zwrócić pustą listę. Pliki referencyjne mają w jakikolwiek sposób pasować do promta. Czyli jak prompt mowi o jakiejś postaci to zwróć pliki z tą postacią lub grupe pasującą do referencji. `;
